...
typedef NS_ENUM(NSInteger,SGRequest){
    SGImageRecognizer,
    SGPageAnimation,
    SGSearchRidging,
    SGUnicode,
...
typedef NS_ENUM(NSInteger,SGCollectionEditor){
    SGLaunch,
...
typedef void(^TWSocketDidReceiveBlock)(id message ,SGCollectionEditor type);

@interface OTablePlay : NSObject
...
@property (nonatomic,assign,readonly)SGRequest fl_socketStatus;
